...
export const TrackingDemo = () => {
  ...
  return (
    <section className="w-full rounded-2xl border border-zinc-200/90 bg-white/75 p-5 shadow-lg shadow-zinc-950/5 ring-1 ring-black/5 backdrop-blur-md dark:border-zinc-700/80 dark:bg-zinc-900/75 dark:shadow-black/30 dark:ring-white/10 sm:p-6">
      ...
      <div className="mt-4 border-t border-zinc-200/90 pt-4 dark:border-zinc-700/80">
        <h2 className="mb-3 text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">
          Try actions
        </h2>
